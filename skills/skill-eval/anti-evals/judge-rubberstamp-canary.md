...
**When to run.** Every PR that touches `skills/skill-eval/judge-prompt.md` or `assertion-rules.md` § "Phase 4 — judge-LLM fuzzy matching". Also include in any future `/skill-eval --anti-evals` mode.
...
>
> ```
> [0] tool=Read    target="skills/tdd/SKILL.md"
