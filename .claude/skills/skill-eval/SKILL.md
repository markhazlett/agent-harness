...
8. **Report PASS/FAIL** with itemized diffs. One line per missing expected step / forbidden action that fired / wrong decision / missing section / forbidden substring / missing regex / missing citation / unrecognized rationalization.
